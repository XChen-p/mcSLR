...
kGrid{1}=permute(kGrid{1},[2 1]);
%kGrid{2}=single(kGrid{2});
kGrid{3}=permute(kGrid{3},[3 1 2]);
for m=1:3
...
rGrid{1}=permute(rGrid{1},[2 1]);
%rGrid{2}=single(rGrid{2});
rGrid{3}=permute(rGrid{3},[3 1 2]);
